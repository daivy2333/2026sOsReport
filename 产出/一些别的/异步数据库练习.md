...
受第一次会议启发，加上后续对异步和协程的理解学习，我快速造了一个 Rust 语言的异步高性能嵌入式关系型数据库项目 [RTsql](https://github.com/daivy2333/RTsql)。根据实验结论，协程面对io密集任务有明显优势，除了网络库就是数据库最能体现io工作了，这里记录其核心设计思路与性能表现。
